...
const schedule: Day[] = [
  ...
  },
  {
    ...
    sessions: [
      ...
      { time: "8:00–9:30 pm", title: "Music concert \"We Belong to the Land\" by Moonshine", speaker: "Nan Franzblau and Wind Coral", speakerUrl: "/activities#moonshine", type: "social" },
